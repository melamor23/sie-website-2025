<script setup>
  ...
  const service = computed(() => {
    if(!services.value) {
        ...
        return services.value.find((service) => service.name === route.params.id).name;
    }
  });
</script>
    ...
    <div class="relative isolate overflow-hidden bg-white py-24 sm:py-32">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          ...
          <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">{{ service }}</h1>
