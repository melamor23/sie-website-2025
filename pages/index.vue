...
<template>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
        ...
        <img src="../assets/img/mainimage.jpg" alt=" "class="absolute inset-0 -z-10 w-full min-h-[800px] sm:min-h-[800px] lg:min-h-[1000px] object-cover"/>
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-left">
            <h1 class="text-balance text-5xl font-semibold tracking-tight text-white sm:text-4xl">A new generation energy <br>company committed to <br><strong>innovation</strong> and <strong>sustainability</strong></h1>
            <p class="mt-8 text-white text-sm font-medium sm:text-lg">
                From our strong core in the hydrocarbons industry, we aspire to gradually transfer skills and capabilities to the extraction of geothermal energy, and the storage of carbon dioxide in the subsurface.
            </p>
            <div class="mt-10 flex items-left justify-left gap-x-6">
                <a href="#" class="rounded-md bg-white/30 px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-white/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Learn more</a>
            </div>
            </div>
        </div>
